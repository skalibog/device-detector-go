...
// Code transcribed mechanically from matomo/device-detector
// Parser/Client/Browser.php (availableBrowsers, browserFamilies,
// mobileOnlyBrowsers). Order is preserved to mirror PHP lookup semantics.

// browserCode pairs a browser's internal short code with its name.
type browserCode struct {
	Short string
	Name  string
}

// familyCodes maps a browser family to the short codes belonging to it.
type familyCodes struct {
	Family string
	Codes  []string
}

// availableBrowsers mirrors Browser::$availableBrowsers (short code -> name).
var availableBrowsers = []browserCode{
	{"V1", "Via"},
...
// browserFamilies mirrors Browser::$browserFamilies.
var browserFamilies = []familyCodes{
	{"Android Browser", []string{"AN"}},
	{"BlackBerry Browser", []string{"BB"}},
	{"Baidu", []string{"BD", "BS", "H6"}},
	{"Amiga", []string{"AV", "AW"}},
	{"Chrome", []string{"CH", "2B", "7S", "A0", "AC", "A4", "AE", "AH", "AI", "AO", "AS", "BA", "BM", "BR", "C2", "C3", "C5", "C4", "C6", "CC", "CD", "CE", "CF", "CG", "1B", "CI", "CL", "CM", "CN", "CP", "CR", "CV", "CW", "DA", "DD", "DG", "DR", "EC", "EE", "EU", "EW", "FA", "FS", "GB", "GI", "H2", "HA", "HE", "HH", "HS", "I3", "IR", "JB", "KN", "KW", "LF", "LL", "LO", "M1", "MA", "MD", "MR", "MS", "MT", "MZ", "NM", "NR", "O0", "O2", "O3", "OC", "PB", "PT", "QU", "QW", "RM", "S4", "S6", "S8", "S9", "SB", "SG", "SS", "SU", "SV", "SW", "SY", "SZ", "T1", "TA", "TB", "TG", "TR", "TS", "TU", "TV", "UB", "UR", "VE", "VG", "VI", "VM", "WP", "WH", "XV", "YJ", "YN", "FH", "B1", "BO", "HB", "PC", "LA", "LT", "PD", "HR", "HU", "HP", "IO", "TP", "CJ", "HQ", "HI", "PN", "BW", "YO", "DC", "G8", "DT", "AP", "AK", "UI", "SD", "VN", "4S", "2S", "RF", "LR", "SQ", "BV", "L1", "F0", "KS", "V0", "C8", "AZ", "MM", "BT", "N0", "P0", "F3", "VS", "DU", "D0", "P1", "O4", "8S", "H3", "TE", "WB", "K1", "P2", "XO", "U0", "B0", "VA", "X0", "NX", "O5", "R1", "I1", "HO", "A5", "X1", "18", "B5", "B6", "TC", "A6", "2X", "F4", "YG", "WR", "NA", "DM", "1M", "A7", "XN", "XT", "XB", "W1", "HT", "B8", "F5", "B9", "WA", "T0", "HC", "O6", "P7", "LJ", "LC", "O7", "N2", "A8", "P8", "RB", "1W", "EV", "I9", "V4", "H4", "1T", "M5", "0S", "0C", "ZR", "D6", "F6", "RC", "WD", "P3", "FT", "A9", "X2", "N3", "GD", "O9", "Q3", "F7", "K2", "P5", "H5", "V3", "K3", "Q4", "G2", "R2", "WX", "XP", "3I", "BG", "R0", "JO", "OL", "GN", "W4", "QI", "E1", "RI", "8B", "5B", "K4", "WK", "T3", "K5", "MU", "9P", "K6", "VR", "N9", "M9", "F9", "0P", "0A", "JR", "D3", "TK", "BP", "2F", "2M", "K7", "1N", "8A", "H7", "X3", "T4", "X4", "5O", "8C", "3M", "6I", "2P", "PU", "7I", "X5", "AL", "3P", "W2", "ZB", "HN"}},
	{"Firefox", []string{"FF", "BI", "BF", "BH", "BN", "C0", "CU", "EI", "F1", "FB", "FE", "AX", "FM", "FR", "FY", "I4", "IF", "8P", "IW", "LH", "LY", "MB", "MN", "MO", "MY", "OA", "OS", "PI", "PX", "QA", "S5", "SX", "TF", "TO", "WF", "ZV", "FP", "AD", "2I", "P9", "KJ", "WY", "VK", "W5", "7C", "N7", "W7"}},
	{"Internet Explorer", []string{"IE", "CZ", "BZ", "IM", "PS", "3A", "4A", "RN", "2E"}},
	{"Konqueror", []string{"KO"}},
	{"NetFront", []string{"NF"}},
	{"NetSurf", []string{"NE"}},
	{"Nokia Browser", []string{"NB", "DO", "NO", "NV"}},
	{"Opera", []string{"OP", "OG", "OH", "OI", "OM", "ON", "OO", "O1", "OX", "Y1"}},
	{"Safari", []string{"SF", "S7", "MF", "SO", "PV"}},
	{"Sailfish Browser", []string{"SA"}},
}

// mobileOnlyBrowsersList mirrors Browser::$mobileOnlyBrowsers.
var mobileOnlyBrowsersList = []string{
